...
interface LocalDataRouteParams {
  position: {
    latitude: number;
    longitude: number;
  }
...
export default function LocalData(){
  ...
  const params = route.params as LocalDataRouteParams;
...
async function  handleSelectImages(){
  ...
  if(status !== 'granted'){
    alert('Eitaa, precisamos de acesso às suas fotos');
    return;
  }
...
return(
  <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
    ...
    />
      ...
      <Text style={styles.title}>Informações para Coleta</Text>
      ...
      <RectButton style={styles.nextButton} onPress={handleCreateLocal}>
